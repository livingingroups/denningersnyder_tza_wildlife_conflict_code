...
We typically want to known the effect of a treatment/predictor/exposure on an outcome variable. 
...
One must also ensure that causes come before effects, and X preceeds Y. 
...
Below is our DAG for understanding what causes crop conflict in the Greater Grumeti Ecosystem Area. This is an `.Rmd` version of Figure 2 in the main text.
...
7. farm_size -> num_protect: Farm size influences the type of protection, which influences the number of strategies used. This is really an indirect pathway.
...
19. sd -> bd: Cities expand toward protected areas, less dense at edges. 500m buffer & preservation mean that density is lower right next to protected area.

20. sd -> crop_damage: Different animals have different risk tolerances, some venture far from protected area.
...
26. slope -> c2070: 2070 is more likely on hillsides either due to the difficulty require in cutting it down, or ecological conditions conducive to forest growth.
