...
p_livestock_params <- list(
  ...
  b_LSH_lion = plsh$b_LSH + plsh$b_LSHs[,1],
  b_GU_lion = pguaXhh$b_GU + pguaXhh$b_GUs[,1], #highlight collider potential
  b_GUxLSH_lion = pguaXhh$b_GUxLSH + pguaXhh$b_GUxLSHs[,1]
)
