...
```
  ...
  2) bd -> conflict: building density signifies human presence, and carnivores avoiddense areas. 
...
```
 ...
 10)  hh_size -> num_protect: larger households engage more effor in protection 
  ...
  13) see_field -> num_protect: Some strategies can only be used when you can or can't see field
